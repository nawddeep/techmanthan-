...
npm run dev
Navigate your browser to http://localhost:3000. The dashboard proxy is deeply integrated to bypass frontend CORS requirements securely by communicating directly with the 127.0.0.1:8000 AI endpoints!
